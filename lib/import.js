...
var DIR = "/Users/dreamarts/WebstormProjects/h22ka/";
...
var erros = [
  "convert/h22ka01663.xml",
  "convert/h22ka07505.xml",
  "convert/h22ka17202.xml",
  "convert/h22ka28214.xml",
  "convert/h22ka33681.xml",
  "convert/h22ka39412.xml"
];
    ...
    async.eachLimit(files, 10, function (file, next) {
      ...
      fs.readFile(_path, function (err, xml) {
        try {
          ...
          // var obj = JSON.parse(parser.toJson(xml));
          //console.log(file);
          _import(collection, obj, function() {
            next();
          });
        } catch (e) {
...
function _import(collection, obj, callback) {
  var GeometricFeature = obj['G-XML'].MetricGeospace.GeometricFeature;
  async.each(GeometricFeature, function(obj, next) {
    var data = {};
